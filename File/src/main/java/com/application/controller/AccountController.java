...
//	}
	...
	@RequestMapping(value = "/{name}",method=RequestMethod.GET)
	public Status Signup(@PathVariable("name")String name,@RequestBody PassInfo password,HttpServletRequest httpServletRequest) {
		return AccountService.signup(name,password,httpServletRequest);
	}

	
	@RequestMapping(method=RequestMethod.POST)
	public Status Login(@RequestBody User user,HttpServletRequest httpServletRequest) {
		return AccountService.login(user,httpServletRequest);
	}
